...
async function loadFavorites() {
  ...
  try {
    ...
    if (response.ok) {
      ...
      favoritesGrid.innerHTML = '<div class="col-12 text-center">Error loading favorites</div>';
    }
  } catch (error) {
    favoritesGrid.innerHTML = '<div class="col-12 text-center">Network error</div>';
  }
}
...
function displayFavorites(favoriteItems) {
  ...
  const favoritesHTML = favoriteItems.map(favorite => {
        ...
        <div class="product-card">
          ...
          <div class="product-info">
            ...
            <div class="product-actions">
              ...
              <button class="btn btn-danger btn-sm" onclick="removeFromFavorites(${product.id})">Remove from Favorites</button>
            </div>
          </div>
        </div>
      </div>
